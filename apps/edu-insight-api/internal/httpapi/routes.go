...
func RegisterRoutes(engine *gin.Engine, cfg config.Config, classroomService appclassroom.Service, scoreService appscore.Service, insightService appinsight.Service) {
