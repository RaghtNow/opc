...
func RegisterClassroomRoutes(router *gin.RouterGroup, service appclassroom.Service) {
	router.POST("/classes", func(c *gin.Context) {
		var req domainclassroom.CreateClassRequest
		if err := c.ShouldBindJSON(&req); err != nil {
			c.JSON(http.StatusBadRequest, gin.H{"message": "invalid request", "error": err.Error()})
			return
		}
		workspace, err := service.CreateClass(req)
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"message": "create class failed", "error": err.Error()})
			return
		}
	...
	router.GET("/classes/current", func(c *gin.Context) {
		workspace, err := service.GetWorkspace(classIDParam(c))
		if err != nil {
	...
	router.POST("/classes/current/students", func(c *gin.Context) {
		...
		workspace, err := service.CreateStudent(classIDParam(c), req)
		if err != nil {
	...
	router.PATCH("/classes/current/students/:id", func(c *gin.Context) {
		...
		workspace, ok, err := service.UpdateStudent(classIDParam(c), c.Param("id"), req)
		if err != nil {
	...
	router.DELETE("/classes/current/students/:id", func(c *gin.Context) {
		workspace, ok, err := service.DeleteStudent(classIDParam(c), c.Param("id"))
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"message": "delete student failed", "error": err.Error()})
			return
		}
		if !ok {
			c.JSON(http.StatusNotFound, gin.H{"message": "student not found"})
	...
	router.POST("/classes/current/students/import", func(c *gin.Context) {
		...
		workspace, summary, err := service.ImportStudents(classIDParam(c), fileName, content)
		if err != nil {
	...
	router.POST("/classes/current/teachers", func(c *gin.Context) {
		...
		workspace, err := service.CreateTeacher(classIDParam(c), req)
		if err != nil {
	...
	router.PATCH("/classes/current/teachers/:id", func(c *gin.Context) {
		...
		workspace, ok, err := service.UpdateTeacher(classIDParam(c), c.Param("id"), req)
		if err != nil {
	...
	router.DELETE("/classes/current/teachers/:id", func(c *gin.Context) {
		workspace, ok, err := service.DeleteTeacher(classIDParam(c), c.Param("id"))
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"message": "delete teacher failed", "error": err.Error()})
			return
		}
		if !ok {
			c.JSON(http.StatusNotFound, gin.H{"message": "teacher not found"})
	...
	router.POST("/classes/current/teachers/import", func(c *gin.Context) {
		...
		workspace, summary, err := service.ImportTeachers(classIDParam(c), fileName, content)
		if err != nil {
	...
	router.POST("/classes/current/teachers/:id/bind-account", func(c *gin.Context) {
		workspace, ok, err := service.BindTeacherAccount(classIDParam(c), c.Param("id"))
		if err != nil {
	...
	router.POST("/classes/current/teachers/:id/sync-permission", func(c *gin.Context) {
		workspace, ok, err := service.SyncTeacherPermission(classIDParam(c), c.Param("id"))
		if err != nil {
	...
	router.PATCH("/classes/current/policies/:id", func(c *gin.Context) {
		...
		workspace, ok, err := service.UpdatePolicy(classIDParam(c), c.Param("id"), req)
		if err != nil {
