...
export const navItems: NavItem[] = [
  { id: 'overview', label: '工作台', hint: '待办、阻塞与快捷入口' },
  { id: 'classes', label: '班级与师生', hint: '班级主数据维护' },
...
export const workContexts: WorkContext[] = [
  {
    ...
    roleLabel: '班主任',
    primaryLabel: '班级管理',
    secondaryLabel: '按当前班级切换',
    description: '维护当前班级的学生、任课老师、成绩与同步链路'
  },
  {
    id: 'subject-math',
    roleLabel: '任课老师',
    primaryLabel: '任课分析',
    secondaryLabel: '按授权班级切换',
    description: '只看当前班数学成绩、波动与薄弱学生'
  }
]

export const subjectScopeClasses: SubjectScopeClass[] = [
  { id: 'admin-class-g2-3', label: '高二（3）班' },
  { id: 'admin-class-g1-8', label: '高一（8）班' }
]
